(function () {
     ...
     * unique 9-bit value. In either case a winner can thus be easily determined 
     * by checking whether the player's current 9 bits have covered any
